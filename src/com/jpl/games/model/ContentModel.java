...
//        subScene.getScene().getRoot().setId("pane");
        subScene = new SubScene(root3D,paneW,paneH,true,javafx.scene.SceneAntialiasing.BALANCED);
        subScene.setCamera(camera);
//        subScene.getScene().getStylesheets().addAll(this.getClass().getResource("estilos.css").toExternalForm());


       //subScene.setStyle("-fx-background-image: url(\"/imagenes/fondo_rubik_edit1.jpeg\");");
//        subScene.setFill(Color.BLACK);  //AQUI VA EL FONDO
        setListeners(true);
    }
